    ...
    <div>
        ...
        <div class="banner" @click="handBannerClick">
            ...
            <div class="banner-info">
                ...
                <div class="message">
                    <span class="l-icon l-icon-img"></span>
                    36
                </div>
            </div>
        </div>
...
.banner {
    ...
    .banner-info {
        ...
        bottom: 0;
        font-size: 14px;
        line-height: 28rem/@fontSize;
        height:28rem/@fontSize ;
        display: flex;
        ...
        .title {
            ...
            letter-spacing: 2rem/@fontSize;
        }
        .message {
            font-size: 14px;
            color: #fff;
            padding: 0 12rem/@fontSize;
            .l-icon-img {
                font-size: 20px;
